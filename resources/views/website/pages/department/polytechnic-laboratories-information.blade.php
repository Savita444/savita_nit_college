                                ...
                                <div>
                                    ...
                                    <div style="margin-left: 20px;">
                                        ...
                                        <div style="margin-top: 10px;margin-right:15px;">
                                            <p>{{ strip_tags($data->laboratories_description) }}</p>
                                        </div>
                                        <img id="english" src="{{ Config::get('DocumentConstant.LABORATORIES_VIEW') }}{{ $data->photo }}" class=" img-thumbnail  hidden-sm" height="300px" width="700px">
                                    </div>
                                    @endif
                                    @endforeach
                                    @endif
